...
import 'package:adas/extensions/extensions.dart';
...
class ImageUtils {
  ...
  static imageLib.Image convertBGRA8888ToImage(CameraImage cameraImage) {
    imageLib.Image img = imageLib.Image.fromBytes(
        cameraImage.planes[0].width.makeItNullSafe(),
        cameraImage.planes[0].height.makeItNullSafe(),
  ...
  static imageLib.Image convertYUV420ToImage(CameraImage cameraImage) {
    ...
    final int uvPixelStride =
        cameraImage.planes[1].bytesPerPixel.makeItNullSafe();
